Repack (https://github.com/edujugon/PushNotification) edit Apn, Gcm, add Sms channel
...
```
composer require hanymigame/smspush-notification
```
...
```
php artisan vendor:publish --provider="HG\SmsPushNotification\Providers\SmsPushNotificationServiceProvider" --tag="config"
```

> Go to [laravel facade sample](https://github.com/HanymiGame/SmsPushNotification#laravel-alias-facade) directly.

### Configuration

After publishing the configuration, you can find the Push service config in config/smspushnotification.php
...
```php
$push->setUrl('http://newSmsPushServiceUrl.com');
```
...
- [setService](https://github.com/HanymiGame/SmsPushNotification#setservice)
- [setMessage](https://github.com/HanymiGame/SmsPushNotification#setmessage)
- [setDevicesToken](https://github.com/HanymiGame/SmsPushNotification#setdevicestoken)
- [send](https://github.com/HanymiGame/SmsPushNotification#send)
- [getFeedback](https://github.com/HanymiGame/SmsPushNotification#getfeedback)
- [getUnregisteredDeviceTokens](https://github.com/HanymiGame/SmsPushNotification#getunregistereddevicetokens)
- [setConfig](https://github.com/HanymiGame/SmsPushNotification#setconfig)
- [setUrl](https://github.com/HanymiGame/SmsPushNotification#seturl)

### Only for Gcm and Fcm

- [setApiKey](https://github.com/HanymiGame/SmsPushNotification#setapikey)

### Only for Fcm

- [sendByTopic](https://github.com/HanymiGame/SmsPushNotification#sendbytopic)

> Go to [Usage samples](https://github.com/HanymiGame/SmsPushNotification#usage-samples) directly.
...
```php
$push->setMessage(['This is the SMS message'])
        ->setDevicesToken(['79998887766','75554443322'...]);
```
...
```php
$push = new SmsPushNotification('fcm');
...
```php
SmsPushNotification::setService('fcm')
                        ->setMessage([
                             'notification' => [
                                     'title'=>'This is the title',
                                     'body'=>'This is the message',
...
If a notification supports being sent as an push message, you should define  `toApn` and/or `toFcm`/`toGcm` methods on the notification class. This method will receive a `$notifiable` entity and should return a  `HG\SmsPushNotification\Messages\SmsPushMessage` instance:

```php
public function toApn($notifiable)
{
    return new SmsPushMessage('Hello world');
}
```
